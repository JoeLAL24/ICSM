...
class CoSODNet(nn.Module):
    ...
    def forward(self, input):
        ...
        enc_feas.update({self.gr_fea_name: gr_fea}) # gr_fea_name即conv5_GA，本行意为将conv5_GA:gr_fea加入enc_feas中

        result = self.cosod_former(enc_feas) #现在的enc_feas有6个键值对，加上了conv5_GA
